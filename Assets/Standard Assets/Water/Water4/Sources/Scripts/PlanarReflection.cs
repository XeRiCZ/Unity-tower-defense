...
{	
	...
	{		
        ...
        reflectCamera.farClipPlane = 1000;
        reflectCamera.useOcclusionCulling = false;
	...
	{
		RenderTexture rt = new RenderTexture(Mathf.FloorToInt(cam.pixelWidth*0.75F), Mathf.FloorToInt(cam.pixelHeight*0.75F), 24);	
	...
	private void RenderReflectionFor (Camera cam, Camera reflectCamera) 
	{
        ...
        float terDetailMem = ter.detailObjectDensity;
        float terBillboard = ter.treeBillboardDistance;
        //ter.detailObjectDistance = 0;
        //ter.treeBillboardDistance = 20f;
        ...
        terDetailMem = ter.detailObjectDistance;
        ter.detailObjectDistance = 0;
        terBillboard = ter.treeBillboardDistance;
        ter.treeBillboardDistance = 40.0f;
		reflectCamera.Render();
        ter.detailObjectDistance = terDetailMem;
        ter.treeBillboardDistance = terBillboard;
